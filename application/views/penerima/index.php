      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="no_wa_penerima" id="no_wa_penerima" class="form-control" required value="<?= set_value('no_wa_penerima'); ?>" placeholder="Nama Penerima">
            <?= form_error('no_wa_penerima', '<small class="form-text text-danger">', '</small>'); ?>
          </div>
          <div class="form-group">
            <label for="alamat_penerima">Alamat Penerima</label>
            <textarea name="alamat_penerima" id="alamat_penerima" class="form-control" required placeholder="Nama Penerima"><?= set_value('alamat_penerima'); ?></textarea>

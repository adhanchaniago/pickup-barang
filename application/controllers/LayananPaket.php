...
class LayananPaket extends CI_Controller {
	...
	public function datatable()
	{
		...
		foreach ($list as $item) {
			...
			$row[] 	= 'Kec. '.$item->kec_asal.','.$item->kab_asal.', Prov. '.$item->prov_asal.', '.$item->negara_asal;
			$row[] 	= 'Kec. '.$item->kec_tujuan.','.$item->kab_tujuan.', Prov. '.$item->prov_tujuan.', '.$item->negara_tujuan;
